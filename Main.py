...
#Creaciones de las soluciones para dibujar sobre los frames y obtener 
#la pose
...
class MiApp(QMainWindow):
	def __init__(self):
		...
		self.ui.btn_Bluetooth.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.Connection_page))
...
class Streaming(QThread):
	...
	def run(self):
		...
		emotion_recognizer.read("C:/Users/USUARIO LENOVO/Desktop/DinamicMenu/Emotions/modelitoLBPH.xml")
